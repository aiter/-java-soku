		...
		<script language="javascript">
			...
			function checkUser(u)
			{
				...
				if(xmlReq.readyState == 4){
					...
					if(da==1){
						document.getElementById("checkmsg").innerHTML="该用户名可以正常使用!";
						document.getElementById("checkmsg").style.color="green";
						}
						else{
						document.getElementById("checkmsg").innerHTML="该用户名已经被使用!";
						document.getElementById("checkmsg").style.color="red";
						}
					}
				}
				}
				xmlReq.open("post", "check.html", true);
				xmlReq.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				xmlReq.send("name="+name);
			}
		</script>
	</head>
	<body bgcolor="#FFFFFF" text="#000000" topmargin="2">
	<div id="checkmsg"></div>
	<s:form action="userstore.html" onsubmit="return checkForm(this);">
			<s:textfield id="name" name="u.name" label="用户名" onblur="checkUser();"  required="true"/>
