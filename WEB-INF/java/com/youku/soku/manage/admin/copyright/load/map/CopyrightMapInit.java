 ...
 */
public class CopyrightMapInit
{
    public static final void init()
        throws TorqueException
    {
        com.youku.soku.manage.admin.copyright.load.CopyrightConfPeer.getMapBuilder();
        com.youku.soku.manage.admin.copyright.load.CopyrightResultPeer.getMapBuilder();
    }
}
