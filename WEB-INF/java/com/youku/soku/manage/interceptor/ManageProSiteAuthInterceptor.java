...
public class ManageProSiteAuthInterceptor extends BaseManageAuthenticationInterceptor {
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        if (!isAuthenticated) {
        	...
        	boolean isPermit = hasPermission(user, Constants.MANAGE_PROTOCOL_SITE, permissionMap);
