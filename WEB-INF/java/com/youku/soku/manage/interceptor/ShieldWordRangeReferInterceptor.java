...
public class ShieldWordRangeReferInterceptor extends BaseManageAuthenticationInterceptor {
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        if (!isAuthenticated) {
        	...
        	boolean isPermit = hasPermission(user, Constants.SHIELD_WORD_RANGE_REFER, permissionMap);
