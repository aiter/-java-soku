...
public class ManageItervenKeywordAuthInterceptor extends BaseManageAuthenticationInterceptor {
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        if (!isAuthenticated) {
        	...
        	boolean isPermit = hasPermission(user, Constants.MANAGE_INTERVEN_KEYWORD, permissionMap);
