...
public class ManageKnowledgeColumnAuthInterceptor extends BaseManageAuthenticationInterceptor {
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        if (!isAuthenticated) {
        	...
        	boolean isPermit = hasPermission(user, Constants.MANAGE_KNOWLEDGE_COLUMN, permissionMap);
