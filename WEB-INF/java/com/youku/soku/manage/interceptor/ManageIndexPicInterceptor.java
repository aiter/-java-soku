...
public class ManageIndexPicInterceptor extends BaseManageAuthenticationInterceptor {
    ...
    public String intercept(ActionInvocation actionInvocation) throws Exception {
        ...
        if (!isAuthenticated) {
        	...
        	boolean isPermit = hasPermission(user, Constants.MANAGE_INDEX_PIC, permissionMap);
