...
public class TeleplaySiteVersionBo {
	 /** The value for the id field */
    private int id;

    /** The value for the fkTeleplayVersionId field */
    private int fkTeleplayVersionId;
    ...
    /** The value for the teleplay name */
    private String names;
    
    /** The value for the teleplay version */
	...
	public int getFkTeleplayVersionId() {
		return fkTeleplayVersionId;
	}

	public void setFkTeleplayVersionId(int fkTeleplayVersionId) {
		this.fkTeleplayVersionId = fkTeleplayVersionId;
	}
