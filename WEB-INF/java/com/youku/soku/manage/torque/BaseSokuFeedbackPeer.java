...
// Local classes
import com.youku.soku.manage.torque.map.*;
 ...
 *
 */
public abstract class BaseSokuFeedbackPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SokuFeedbackMapBuilder.CLASS_NAME);
    }
    ...
    public static final String MESSAGE;
      /** the column name for the ip_host field */
    ...
    {
        DATABASE_NAME = "soku";
        TABLE_NAME = "soku_feedback";

              ID = "soku_feedback.id";
                  KEYWORD = "soku_feedback.keyword";
                  URL = "soku_feedback.url";
                  STATE = "soku_feedback.state";
                  SOURCE = "soku_feedback.source";
                  SCORE = "soku_feedback.score";
                  MESSAGE = "soku_feedback.message";
                  IP_HOST = "soku_feedback.ip_host";
                  UPDATE_TIME = "soku_feedback.update_time";
                  CREATE_TIME = "soku_feedback.create_time";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SokuFeedbackMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SokuFeedbackMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.torque.SokuFeedback";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(MESSAGE);
          criteria.addSelectColumn(IP_HOST);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SokuFeedback row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SokuFeedback obj = (SokuFeedback) cls.newInstance();
            SokuFeedbackPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setState(row.getValue(offset + 3).asInt());
                  obj.setSource(row.getValue(offset + 4).asInt());
                  obj.setScore(row.getValue(offset + 5).asDouble());
                  obj.setMessage(row.getValue(offset + 6).asString());
                  obj.setIpHost(row.getValue(offset + 7).asString());
                  obj.setUpdateTime(row.getValue(offset + 8).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SokuFeedback> results = new ArrayList<SokuFeedback>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SokuFeedbackPeer.row2Object(row, 1,
                SokuFeedbackPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> doSelect(SokuFeedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SokuFeedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SokuFeedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SokuFeedback obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SokuFeedback) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SokuFeedback obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SokuFeedback) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SokuFeedback obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SokuFeedback) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SokuFeedback obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SokuFeedback obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(MESSAGE, obj.getMessage());
              criteria.add(IP_HOST, obj.getIpHost());
    ...
    public static Criteria buildSelectCriteria( SokuFeedback obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SokuFeedback retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedback retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedback retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SokuFeedback retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedback retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SokuFeedback> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SokuFeedback> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedback> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SokuFeedback> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SokuFeedback>();
        }
        else
        {
            Criteria criteria = new Criteria();
