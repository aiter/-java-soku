...
import com.youku.soku.manage.torque.map.ItemMapBuilder;
    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ItemMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ItemMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the navigation field */
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ItemMapBuilder.CLASS_NAME);
            }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.torque.Item";
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NAVIGATION);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNavigation(row.getValue(offset + 3).asInt());
            obj.setIndexType(row.getValue(offset + 4).asInt());
            obj.setSort(row.getValue(offset + 5).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
    ...
    public static Criteria buildCriteria( Item obj )
    {
        ...
        criteria.add(NAVIGATION, obj.getNavigation());
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Item retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
