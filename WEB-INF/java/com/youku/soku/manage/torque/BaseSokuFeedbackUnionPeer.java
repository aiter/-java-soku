 ...
 *
 */
public abstract class BaseSokuFeedbackUnionPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SokuFeedbackUnionMapBuilder.CLASS_NAME);
    }
    ...
    public static final String FEEDBACK_DATE;
    ...
    {
        DATABASE_NAME = "soku";
        TABLE_NAME = "soku_feedback_union";

              ID = "soku_feedback_union.id";
                  STATE = "soku_feedback_union.state";
                  SOURCE = "soku_feedback_union.source";
                  FEEDBACK_DATE = "soku_feedback_union.feedback_date";
                  TYPE = "soku_feedback_union.type";
                  COUNT = "soku_feedback_union.count";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SokuFeedbackUnionMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SokuFeedbackUnionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.torque.SokuFeedbackUnion";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseSokuFeedbackUnionPeer
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(FEEDBACK_DATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SokuFeedbackUnion row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SokuFeedbackUnion obj = (SokuFeedbackUnion) cls.newInstance();
            SokuFeedbackUnionPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      SokuFeedbackUnion obj)
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setState(row.getValue(offset + 1).asInt());
                  obj.setSource(row.getValue(offset + 2).asInt());
                  obj.setFeedbackDate(row.getValue(offset + 3).asUtilDate());
                  obj.setType(row.getValue(offset + 4).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SokuFeedbackUnion> results = new ArrayList<SokuFeedbackUnion>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SokuFeedbackUnionPeer.row2Object(row, 1,
                SokuFeedbackUnionPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> doSelect(SokuFeedbackUnion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SokuFeedbackUnion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SokuFeedbackUnion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SokuFeedbackUnion obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SokuFeedbackUnion) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SokuFeedbackUnion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SokuFeedbackUnion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SokuFeedbackUnion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SokuFeedbackUnion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SokuFeedbackUnion obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SokuFeedbackUnion obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(FEEDBACK_DATE, obj.getFeedbackDate());
    ...
    public static Criteria buildSelectCriteria( SokuFeedbackUnion obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SokuFeedbackUnion retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedbackUnion retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedbackUnion retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SokuFeedbackUnion retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SokuFeedbackUnion retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SokuFeedbackUnion> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (SokuFeedbackUnion)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SokuFeedbackUnion> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SokuFeedbackUnion> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SokuFeedbackUnion> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SokuFeedbackUnion>();
        }
        else
        {
            Criteria criteria = new Criteria();
