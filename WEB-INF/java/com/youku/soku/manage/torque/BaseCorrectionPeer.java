...
import com.youku.soku.manage.torque.map.CorrectionMapBuilder;
 ...
 *
 */
public abstract class BaseCorrectionPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(CorrectionMapBuilder.CLASS_NAME);
    }
    ...
    public static final String KEYWORD;
      /** the column name for the correct_keyword field */
    public static final String CORRECT_KEYWORD;
    ...
    static
    {
        ...
        TABLE_NAME = "correction";
              ...
              ID = "correction.id";
                  ...
                  CORRECT_KEYWORD = "correction.correct_keyword";
                  STATUS = "correction.status";
                  UPDATE_TIME = "correction.update_time";
                  CREATE_TIME = "correction.create_time";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(CorrectionMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(CorrectionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.torque.Correction";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(CORRECT_KEYWORD);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Correction row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Correction obj = (Correction) cls.newInstance();
            CorrectionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setCorrectKeyword(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Correction> results = new ArrayList<Correction>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(CorrectionPeer.row2Object(row, 1,
                CorrectionPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> doSelect(Correction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Correction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Correction obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Correction obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Correction) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Correction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Correction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Correction obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Correction) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Correction obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Correction obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(KEYWORD, obj.getKeyword());
              criteria.add(CORRECT_KEYWORD, obj.getCorrectKeyword());
    ...
    public static Criteria buildSelectCriteria( Correction obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Correction retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Correction retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Correction retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Correction retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Correction retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Correction> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Correction> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Correction> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Correction> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Correction>();
        }
        else
        {
            Criteria criteria = new Criteria();
