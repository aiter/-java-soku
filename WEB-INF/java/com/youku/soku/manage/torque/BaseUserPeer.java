...
import com.youku.soku.manage.torque.map.UserMapBuilder;
    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(UserMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(UserMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the actual_name field */
    public static final String ACTUAL_NAME;
    /** the column name for the email field */
    public static final String EMAIL;
    /** the column name for the is_active field */
    public static final String IS_ACTIVE;
    /** the column name for the is_shield_system_user field */
    public static final String IS_SHIELD_SYSTEM_USER;
    /** the column name for the is_super_user field */
    public static final String IS_SUPER_USER;
    /** the column name for the date_joined field */
    public static final String DATE_JOINED;
    ...
    static
    {
        ...
        IS_SHIELD_SYSTEM_USER = "user.is_shield_system_user";
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(UserMapBuilder.CLASS_NAME);
            }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.torque.User";
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(ACTUAL_NAME);
        criteria.addSelectColumn(EMAIL);
        criteria.addSelectColumn(IS_ACTIVE);
        criteria.addSelectColumn(IS_SHIELD_SYSTEM_USER);
        criteria.addSelectColumn(IS_SUPER_USER);
        criteria.addSelectColumn(DATE_JOINED);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setActualName(row.getValue(offset + 3).asString());
            obj.setEmail(row.getValue(offset + 4).asString());
            obj.setIsActive(row.getValue(offset + 5).asByte());
            obj.setIsShieldSystemUser(row.getValue(offset + 6).asByte());
            obj.setIsSuperUser(row.getValue(offset + 7).asByte());
            obj.setDateJoined(row.getValue(offset + 8).asUtilDate());
    ...
    public static Criteria buildCriteria( User obj )
    {
        ...
        criteria.add(ACTUAL_NAME, obj.getActualName());
        criteria.add(EMAIL, obj.getEmail());
        criteria.add(IS_ACTIVE, obj.getIsActive());
        criteria.add(IS_SHIELD_SYSTEM_USER, obj.getIsShieldSystemUser());
        criteria.add(IS_SUPER_USER, obj.getIsSuperUser());
        criteria.add(DATE_JOINED, obj.getDateJoined());
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static User retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
