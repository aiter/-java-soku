    ...
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.manage.questionnaire.orm.User";
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(AGE);
        criteria.addSelectColumn(EDUCATION);
        criteria.addSelectColumn(AREA);
        criteria.addSelectColumn(PROFESSION);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setSex(row.getValue(offset + 2).asInt());
            obj.setAge(row.getValue(offset + 3).asInt());
            obj.setEducation(row.getValue(offset + 4).asInt());
            obj.setArea(row.getValue(offset + 5).asInt());
            obj.setProfession(row.getValue(offset + 6).asInt());
            obj.setPhone(row.getValue(offset + 7).asString());
            obj.setEmail(row.getValue(offset + 8).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
    ...
    public static Criteria buildCriteria( User obj )
    {
        ...
        criteria.add(AGE, obj.getAge());
        criteria.add(EDUCATION, obj.getEducation());
        criteria.add(AREA, obj.getArea());
        criteria.add(PROFESSION, obj.getProfession());
