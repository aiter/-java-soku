 ...
 *
 */
public abstract class BaseTypeWordsPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TypeWordsMapBuilder.CLASS_NAME);
    }
    ...
    public static final String STATE;
      /** the column name for the checker field */
    ...
    static
    {
        ...
        TABLE_NAME = "type_words";

              ID = "type_words.id";
                  PROGRAMME_ID = "type_words.programme_id";
                  KEYWORD = "type_words.keyword";
                  CATE = "type_words.cate";
                  PIC = "type_words.pic";
                  STATE = "type_words.state";
                  CHECKER = "type_words.checker";
                  CREATE_DATE = "type_words.create_date";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TypeWordsMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TypeWordsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.soku.top.mapping.TypeWords";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(CHECKER);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TypeWords row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TypeWords obj = (TypeWords) cls.newInstance();
            TypeWordsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setPic(row.getValue(offset + 4).asString());
                  obj.setState(row.getValue(offset + 5).asString());
                  obj.setChecker(row.getValue(offset + 6).asString());
                  obj.setCreateDate(row.getValue(offset + 7).asUtilDate());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TypeWords> results = new ArrayList<TypeWords>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TypeWordsPeer.row2Object(row, 1,
                TypeWordsPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> doSelect(TypeWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TypeWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TypeWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TypeWords obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TypeWords) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TypeWords obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TypeWords) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TypeWords obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TypeWords) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TypeWords obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TypeWords obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(CHECKER, obj.getChecker());
              criteria.add(CREATE_DATE, obj.getCreateDate());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TypeWords obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static TypeWords retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TypeWords retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TypeWords retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TypeWords retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TypeWords retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TypeWords> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TypeWords> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TypeWords> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TypeWords> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TypeWords>();
        }
        else
        {
            Criteria criteria = new Criteria();
