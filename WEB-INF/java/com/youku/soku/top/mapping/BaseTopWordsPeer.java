...
// Local classes
import com.youku.soku.top.mapping.map.*;
 ...
 *
 */
public abstract class BaseTopWordsPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TopWordsMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the programme_id field */
    public static final String PROGRAMME_ID;
    ...
    public static final String URL;
      /** the column name for the top_date field */
    public static final String TOP_DATE;
      /** the column name for the isTop field */
    public static final String ISTOP;
      /** the column name for the create_date field */
    public static final String CREATE_DATE;
  
    static
    {
        DATABASE_NAME = "new_soku_top";
        TABLE_NAME = "top_words";

              ID = "top_words.id";
                  PROGRAMME_ID = "top_words.programme_id";
                  KEYWORD = "top_words.keyword";
                  CATE = "top_words.cate";
                  QUERY_COUNT = "top_words.query_count";
                  VISIBLE = "top_words.visible";
                  PIC = "top_words.pic";
                  URL = "top_words.url";
                  TOP_DATE = "top_words.top_date";
                  ISTOP = "top_words.isTop";
                  CREATE_DATE = "top_words.create_date";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TopWordsMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TopWordsMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(PROGRAMME_ID);
          criteria.addSelectColumn(KEYWORD);
          criteria.addSelectColumn(CATE);
          criteria.addSelectColumn(QUERY_COUNT);
          criteria.addSelectColumn(VISIBLE);
          criteria.addSelectColumn(PIC);
          criteria.addSelectColumn(URL);
          criteria.addSelectColumn(TOP_DATE);
          criteria.addSelectColumn(ISTOP);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TopWords row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TopWords obj = (TopWords) cls.newInstance();
            TopWordsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setProgrammeId(row.getValue(offset + 1).asInt());
                  obj.setKeyword(row.getValue(offset + 2).asString());
                  obj.setCate(row.getValue(offset + 3).asInt());
                  obj.setQueryCount(row.getValue(offset + 4).asInt());
                  obj.setVisible(row.getValue(offset + 5).asInt());
                  obj.setPic(row.getValue(offset + 6).asString());
                  obj.setUrl(row.getValue(offset + 7).asString());
                  obj.setTopDate(row.getValue(offset + 8).asUtilDate());
                  obj.setIstop(row.getValue(offset + 9).asInt());
                  obj.setCreateDate(row.getValue(offset + 10).asUtilDate());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TopWords> results = new ArrayList<TopWords>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TopWordsPeer.row2Object(row, 1,
                TopWordsPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> doSelect(TopWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TopWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TopWords obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TopWords obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TopWords) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TopWords obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TopWords) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TopWords obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TopWords) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TopWords obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TopWords obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(PROGRAMME_ID, obj.getProgrammeId());
              criteria.add(KEYWORD, obj.getKeyword());
              criteria.add(CATE, obj.getCate());
              criteria.add(QUERY_COUNT, obj.getQueryCount());
              criteria.add(VISIBLE, obj.getVisible());
              criteria.add(PIC, obj.getPic());
              criteria.add(URL, obj.getUrl());
              criteria.add(TOP_DATE, obj.getTopDate());
              criteria.add(ISTOP, obj.getIstop());
              criteria.add(CREATE_DATE, obj.getCreateDate());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TopWords obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static TopWords retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TopWords retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TopWords retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TopWords retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TopWords retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TopWords> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TopWords> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TopWords> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TopWords> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TopWords>();
        }
        else
        {
            Criteria criteria = new Criteria();
