...
public class AnimeSearcher {
	private static Log logger = LogFactory.getLog(AnimeSearcher.class);
...
//		 检索系列map,如果有结果则直接返回，不用搜索name_programmeSite表
	...
	public static JSONObject genJson(Programme programme, AnimeInfo info,String site)
			throws Exception {
