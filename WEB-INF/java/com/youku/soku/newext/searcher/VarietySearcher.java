...
import com.youku.soku.newext.util.comparator.EpisodeComparator;
...
public class VarietySearcher {
	private static Log logger=LogFactory.getLog(VarietySearcher.class);
...
public  static JSONObject genJson(Programme programme, VarietyInfo info,String site) throws Exception {
