 ...
 *
 */
public class DocumentaryInfo extends AliasInfo {

	public DocumentaryInfo(AliasInfo aliasInfo) {
		super(NameType.DOCUMENTARY);
...
//    public Map<ProgrammeSite,List<ProgrammeEpisode>> programmeSite_episode=new HashMap<ProgrammeSite,List<ProgrammeEpisode>>(100000);
	...
	public String info() {
		return "{DocumentaryInfo:: name_programme's size: " + name_programme.size() + "; "
