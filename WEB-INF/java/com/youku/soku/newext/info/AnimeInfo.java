 ...
 * 动漫
 */
public class AnimeInfo extends AliasInfo {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3757856875257287654L;
	public AnimeInfo(AliasInfo aliasInfo) {
		super(NameType.ANIME);
...
//    public Map<ProgrammeSite,List<ProgrammeEpisode>> programmeSite_episode=new HashMap<ProgrammeSite,List<ProgrammeEpisode>>(100000);
	...
	public String info() {
		return "{AnimeInfo:: name_programme's size: " + name_programme.size() + "; "
