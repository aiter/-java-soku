 ...
 *
 */
public abstract class BasePlayNamePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(PlayNameMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "play_name";

              ID = "play_name.id";
                  FK_TELEPLAY_ID = "play_name.fk_teleplay_id";
                  NAME = "play_name.name";
                  IS_MAIN = "play_name.is_main";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(PlayNameMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(PlayNameMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.PlayName";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(IS_MAIN);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static PlayName row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            PlayName obj = (PlayName) cls.newInstance();
            PlayNamePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setIsMain(row.getValue(offset + 3).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<PlayName> results = new ArrayList<PlayName>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(PlayNamePeer.row2Object(row, 1,
                PlayNamePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> doSelect(PlayName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(PlayName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(PlayName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(PlayName obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(PlayName) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(PlayName obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(PlayName) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(PlayName obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(PlayName) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(PlayName obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( PlayName obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(IS_MAIN, obj.getIsMain());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( PlayName obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static PlayName retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayName retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayName retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        PlayName retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayName retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<PlayName> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<PlayName> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayName> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<PlayName> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<PlayName>();
        }
        else
        {
            Criteria criteria = new Criteria();
