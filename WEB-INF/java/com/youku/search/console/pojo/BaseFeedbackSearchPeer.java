 ...
 *
 */
public abstract class BaseFeedbackSearchPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(FeedbackSearchMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "feedback_search";
              ...
              ID = "feedback_search.id";
                  ERROR_TYPE = "feedback_search.error_type";
                  DESCRIPTION = "feedback_search.description";
                  KEYWORD = "feedback_search.keyword";
                  PAGE = "feedback_search.page";
                  CREATOR = "feedback_search.creator";
                  CREATETIME = "feedback_search.createtime";
                  URL = "feedback_search.url";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(FeedbackSearchMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(FeedbackSearchMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.FeedbackSearch";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static FeedbackSearch row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            FeedbackSearch obj = (FeedbackSearch) cls.newInstance();
            FeedbackSearchPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setErrorType(row.getValue(offset + 1).asInt());
                  obj.setDescription(row.getValue(offset + 2).asString());
                  obj.setKeyword(row.getValue(offset + 3).asString());
                  obj.setPage(row.getValue(offset + 4).asInt());
                  obj.setCreator(row.getValue(offset + 5).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<FeedbackSearch> results = new ArrayList<FeedbackSearch>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(FeedbackSearchPeer.row2Object(row, 1,
                FeedbackSearchPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> doSelect(FeedbackSearch obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(FeedbackSearch obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(FeedbackSearch obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(FeedbackSearch obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(FeedbackSearch) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(FeedbackSearch obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(FeedbackSearch) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(FeedbackSearch obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(FeedbackSearch) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(FeedbackSearch obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( FeedbackSearch obj )
    {
    ...
    public static Criteria buildSelectCriteria( FeedbackSearch obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static FeedbackSearch retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FeedbackSearch retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FeedbackSearch retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        FeedbackSearch retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FeedbackSearch retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<FeedbackSearch> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<FeedbackSearch> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FeedbackSearch> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<FeedbackSearch> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<FeedbackSearch>();
        }
        else
        {
            Criteria criteria = new Criteria();
