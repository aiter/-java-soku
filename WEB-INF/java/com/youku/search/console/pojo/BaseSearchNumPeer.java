 ...
 *
 */
public abstract class BaseSearchNumPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SearchNumMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "search_num";

              ID = "search_num.id";
                  WORDS = "search_num.words";
                  NUM = "search_num.num";
                  STATUS = "search_num.status";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SearchNumMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SearchNumMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.SearchNum";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SearchNum row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SearchNum obj = (SearchNum) cls.newInstance();
            SearchNumPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setNum(row.getValue(offset + 2).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SearchNum> results = new ArrayList<SearchNum>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SearchNumPeer.row2Object(row, 1,
                SearchNumPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> doSelect(SearchNum obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SearchNum obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SearchNum obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SearchNum obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SearchNum) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SearchNum obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SearchNum) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SearchNum obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SearchNum) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SearchNum obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SearchNum obj )
    {
    ...
    public static Criteria buildSelectCriteria( SearchNum obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SearchNum retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchNum retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchNum retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SearchNum retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchNum retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SearchNum> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SearchNum> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchNum> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SearchNum> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SearchNum>();
        }
        else
        {
            Criteria criteria = new Criteria();
