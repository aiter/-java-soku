 ...
 *
 */
public abstract class BaseTempPlayVersionPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TempPlayVersionMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "temp_play_version";

              ID = "temp_play_version.id";
                  FK_TELEPLAY_ID = "temp_play_version.fk_teleplay_id";
                  CATE = "temp_play_version.cate";
                  SUBCATE = "temp_play_version.subcate";
                  NAME = "temp_play_version.name";
                  STATUS = "temp_play_version.status";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TempPlayVersionMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TempPlayVersionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.TempPlayVersion";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTempPlayVersionPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TempPlayVersion row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TempPlayVersion obj = (TempPlayVersion) cls.newInstance();
            TempPlayVersionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setStatus(row.getValue(offset + 5).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TempPlayVersion> results = new ArrayList<TempPlayVersion>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TempPlayVersionPeer.row2Object(row, 1,
                TempPlayVersionPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> doSelect(TempPlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TempPlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TempPlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TempPlayVersion obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TempPlayVersion) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TempPlayVersion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TempPlayVersion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TempPlayVersion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TempPlayVersion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TempPlayVersion obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TempPlayVersion obj )
    {
    ...
    public static Criteria buildSelectCriteria( TempPlayVersion obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static TempPlayVersion retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TempPlayVersion retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TempPlayVersion retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TempPlayVersion retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TempPlayVersion retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TempPlayVersion> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (TempPlayVersion)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TempPlayVersion> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TempPlayVersion> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TempPlayVersion> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TempPlayVersion>();
        }
        else
        {
            Criteria criteria = new Criteria();
