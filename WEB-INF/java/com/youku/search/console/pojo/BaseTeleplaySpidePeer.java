 ...
 *
 */
public abstract class BaseTeleplaySpidePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TeleplaySpideMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "teleplay_spide";

              ID = "teleplay_spide.id";
                  STATUS = "teleplay_spide.status";
                  NAME = "teleplay_spide.name";
                  CREATETIME = "teleplay_spide.createtime";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TeleplaySpideMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TeleplaySpideMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.TeleplaySpide";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TeleplaySpide row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TeleplaySpide obj = (TeleplaySpide) cls.newInstance();
            TeleplaySpidePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setStatus(row.getValue(offset + 1).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TeleplaySpide> results = new ArrayList<TeleplaySpide>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TeleplaySpidePeer.row2Object(row, 1,
                TeleplaySpidePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> doSelect(TeleplaySpide obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TeleplaySpide obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TeleplaySpide obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TeleplaySpide obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TeleplaySpide) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TeleplaySpide obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TeleplaySpide) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TeleplaySpide obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TeleplaySpide) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TeleplaySpide obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TeleplaySpide obj )
    {
    ...
    public static Criteria buildSelectCriteria( TeleplaySpide obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static TeleplaySpide retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TeleplaySpide retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TeleplaySpide retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TeleplaySpide retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TeleplaySpide retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TeleplaySpide> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TeleplaySpide> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TeleplaySpide> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TeleplaySpide> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TeleplaySpide>();
        }
        else
        {
            Criteria criteria = new Criteria();
