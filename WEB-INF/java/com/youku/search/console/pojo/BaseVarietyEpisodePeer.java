 ...
 *
 */
public abstract class BaseVarietyEpisodePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(VarietyEpisodeMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "variety_episode";

              ID = "variety_episode.id";
                  FK_VARIETY_ID = "variety_episode.fk_variety_id";
                  NAME = "variety_episode.name";
                  ORDER_ID = "variety_episode.order_id";
                  SOURCE_NAME = "variety_episode.source_name";
                  VIDEO_ID = "variety_episode.video_id";
                  ENCODE_VIDEO_ID = "variety_episode.encode_video_id";
                  LOGO = "variety_episode.logo";
                  SECONDS = "variety_episode.seconds";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(VarietyEpisodeMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(VarietyEpisodeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.VarietyEpisode";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VarietyEpisode row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VarietyEpisode obj = (VarietyEpisode) cls.newInstance();
            VarietyEpisodePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setOrderId(row.getValue(offset + 3).asString());
                  obj.setSourceName(row.getValue(offset + 4).asString());
                  obj.setVideoId(row.getValue(offset + 5).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VarietyEpisode> results = new ArrayList<VarietyEpisode>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(VarietyEpisodePeer.row2Object(row, 1,
                VarietyEpisodePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> doSelect(VarietyEpisode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VarietyEpisode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VarietyEpisode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VarietyEpisode obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VarietyEpisode) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VarietyEpisode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VarietyEpisode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VarietyEpisode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VarietyEpisode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VarietyEpisode obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VarietyEpisode obj )
    {
    ...
    public static Criteria buildSelectCriteria( VarietyEpisode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static VarietyEpisode retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyEpisode retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyEpisode retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VarietyEpisode retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyEpisode retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VarietyEpisode> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VarietyEpisode> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyEpisode> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VarietyEpisode> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VarietyEpisode>();
        }
        else
        {
            Criteria criteria = new Criteria();
