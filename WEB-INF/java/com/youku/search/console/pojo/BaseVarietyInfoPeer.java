...
import com.youku.search.console.pojo.map.VarietyInfoMapBuilder;
 ...
 *
 */
public abstract class BaseVarietyInfoPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(VarietyInfoMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "variety_info";

              ID = "variety_info.id";
                  FK_VARIETY_ID = "variety_info.fk_variety_id";
                  EPISODE_COUNT = "variety_info.episode_count";
                  TOTAL_COUNT = "variety_info.total_count";
                  FIXED = "variety_info.fixed";
                  FIRSTLOGO = "variety_info.firstlogo";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(VarietyInfoMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(VarietyInfoMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.VarietyInfo";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VarietyInfo row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VarietyInfo obj = (VarietyInfo) cls.newInstance();
            VarietyInfoPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setEpisodeCount(row.getValue(offset + 2).asInt());
                  obj.setTotalCount(row.getValue(offset + 3).asInt());
                  obj.setFixed(row.getValue(offset + 4).asInt());
                  obj.setFirstlogo(row.getValue(offset + 5).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VarietyInfo> results = new ArrayList<VarietyInfo>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(VarietyInfoPeer.row2Object(row, 1,
                VarietyInfoPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> doSelect(VarietyInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VarietyInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VarietyInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VarietyInfo obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VarietyInfo) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VarietyInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VarietyInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VarietyInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VarietyInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VarietyInfo obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VarietyInfo obj )
    {
    ...
    public static Criteria buildSelectCriteria( VarietyInfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static VarietyInfo retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyInfo retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyInfo retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VarietyInfo retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VarietyInfo retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VarietyInfo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VarietyInfo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VarietyInfo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VarietyInfo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VarietyInfo>();
        }
        else
        {
            Criteria criteria = new Criteria();
