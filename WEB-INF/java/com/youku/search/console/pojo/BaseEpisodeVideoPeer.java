...
{
    /** Serial version */
    private static final long serialVersionUID = 1249459187375L;
    ...
    {
        return getMapBuilder(EpisodeVideoMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "episode_video";
              ...
              ID = "episode_video.id";
                  FK_EPISODE_ID = "episode_video.fk_episode_id";
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(EpisodeVideoMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.EpisodeVideo";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setFkEpisodeId(row.getValue(offset + 1).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<EpisodeVideo> results = new ArrayList<EpisodeVideo>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> doSelect(EpisodeVideo obj) throws TorqueException
    {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<EpisodeVideo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<EpisodeVideo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<EpisodeVideo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<EpisodeVideo>();
        }
        else
        {
            Criteria criteria = new Criteria();
