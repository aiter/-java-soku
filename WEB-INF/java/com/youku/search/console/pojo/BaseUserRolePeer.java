 ...
 *
 */
public abstract class BaseUserRolePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(UserRoleMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(UserRoleMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(UserRoleMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.UserRole";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static UserRole row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            UserRole obj = (UserRole) cls.newInstance();
            UserRolePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<UserRole> results = new ArrayList<UserRole>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(UserRolePeer.row2Object(row, 1,
                UserRolePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> doSelect(UserRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UserRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UserRole obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UserRole obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(UserRole) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UserRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(UserRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UserRole obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(UserRole) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UserRole obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( UserRole obj )
    {
    ...
    public static Criteria buildSelectCriteria( UserRole obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static UserRole retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UserRole retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UserRole retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UserRole retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<UserRole> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UserRole> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<UserRole> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<UserRole>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of UserRole objects pre-filled with their
     * User objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UserRolePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UserRole> doSelectJoinUser(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UserRole> doSelectJoinUser(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        UserPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(UserRolePeer.USER_ID,
            UserPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);
                            ...
                            Class omClass = UserRolePeer.getOMClass();
                    UserRole obj1 = UserRolePeer
            ...
            {
                UserRole temp_obj1 =  results.get(j);
                User temp_obj2 = temp_obj1.getUser();
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UserRole> doSelectJoinRole(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UserRole> doSelectJoinRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        RolePeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(UserRolePeer.ROLE_ID,
            RolePeer.ID);
