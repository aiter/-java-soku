 ...
 *
 */
public abstract class BaseRoleMenuPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(RoleMenuMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(RoleMenuMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(RoleMenuMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.RoleMenu";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static RoleMenu row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            RoleMenu obj = (RoleMenu) cls.newInstance();
            RoleMenuPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<RoleMenu> results = new ArrayList<RoleMenu>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(RoleMenuPeer.row2Object(row, 1,
                RoleMenuPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> doSelect(RoleMenu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RoleMenu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RoleMenu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RoleMenu obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RoleMenu) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RoleMenu obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(RoleMenu) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RoleMenu obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(RoleMenu) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RoleMenu obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( RoleMenu obj )
    {
    ...
    public static Criteria buildSelectCriteria( RoleMenu obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static RoleMenu retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RoleMenu retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RoleMenu retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        RoleMenu retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RoleMenu retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<RoleMenu> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<RoleMenu> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RoleMenu> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<RoleMenu> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<RoleMenu>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of RoleMenu objects pre-filled with their
     * Role objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RoleMenuPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RoleMenu> doSelectJoinRole(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinRole(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RoleMenu> doSelectJoinRole(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        RoleMenuPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        RolePeer.addSelectColumns(criteria);

                        criteria.addJoin(RoleMenuPeer.ROLE_ID,
            RolePeer.ID);
        ...
        List<RoleMenu> results = new ArrayList<RoleMenu>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

                            Class omClass = RoleMenuPeer.getOMClass();
                    RoleMenu obj1 = RoleMenuPeer
            ...
            {
                RoleMenu temp_obj1 =  results.get(j);
                Role temp_obj2 = temp_obj1.getRole();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addRoleMenu(obj1);
                              break;
                }
            }
                      if (newObject)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RoleMenu> doSelectJoinMenu(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RoleMenu> doSelectJoinMenu(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        MenuPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(RoleMenuPeer.MENU_ID,
            MenuPeer.ID);
