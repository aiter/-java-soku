 ...
 *
 */
public abstract class BasePlayVersionPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(PlayVersionMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the fk_teleplay_id field */
    public static final String FK_TELEPLAY_ID;
      /** the column name for the cate field */
    public static final String CATE;
      /** the column name for the subcate field */
    public static final String SUBCATE;
    ...
    public static final String ORDER_ID;
      /** the column name for the reverse field */
    public static final String REVERSE;
      /** the column name for the episode_count field */
    public static final String EPISODE_COUNT;
      /** the column name for the total_count field */
    public static final String TOTAL_COUNT;
      /** the column name for the fixed field */
    public static final String FIXED;
      /** the column name for the firstlogo field */
    public static final String FIRSTLOGO;
  
    static
    {
        DATABASE_NAME = "searchteleplay";
        TABLE_NAME = "play_version";

              ID = "play_version.id";
                  FK_TELEPLAY_ID = "play_version.fk_teleplay_id";
                  CATE = "play_version.cate";
                  SUBCATE = "play_version.subcate";
                  NAME = "play_version.name";
                  VIEW_NAME = "play_version.view_name";
                  ALIAS = "play_version.alias";
                  ORDER_ID = "play_version.order_id";
                  REVERSE = "play_version.reverse";
                  EPISODE_COUNT = "play_version.episode_count";
                  TOTAL_COUNT = "play_version.total_count";
                  FIXED = "play_version.fixed";
                  FIRSTLOGO = "play_version.firstlogo";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(PlayVersionMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(PlayVersionMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(FK_TELEPLAY_ID);
          criteria.addSelectColumn(CATE);
          criteria.addSelectColumn(SUBCATE);
          criteria.addSelectColumn(NAME);
          criteria.addSelectColumn(VIEW_NAME);
          criteria.addSelectColumn(ALIAS);
          criteria.addSelectColumn(ORDER_ID);
          criteria.addSelectColumn(REVERSE);
          criteria.addSelectColumn(EPISODE_COUNT);
          criteria.addSelectColumn(TOTAL_COUNT);
          criteria.addSelectColumn(FIXED);
          criteria.addSelectColumn(FIRSTLOGO);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static PlayVersion row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            PlayVersion obj = (PlayVersion) cls.newInstance();
            PlayVersionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setFkTeleplayId(row.getValue(offset + 1).asInt());
                  obj.setCate(row.getValue(offset + 2).asInt());
                  obj.setSubcate(row.getValue(offset + 3).asInt());
                  obj.setName(row.getValue(offset + 4).asString());
                  obj.setViewName(row.getValue(offset + 5).asString());
                  obj.setAlias(row.getValue(offset + 6).asString());
                  obj.setOrderId(row.getValue(offset + 7).asInt());
                  obj.setReverse(row.getValue(offset + 8).asInt());
                  obj.setEpisodeCount(row.getValue(offset + 9).asInt());
                  obj.setTotalCount(row.getValue(offset + 10).asInt());
                  obj.setFixed(row.getValue(offset + 11).asInt());
                  obj.setFirstlogo(row.getValue(offset + 12).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<PlayVersion> results = new ArrayList<PlayVersion>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(PlayVersionPeer.row2Object(row, 1,
                PlayVersionPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> doSelect(PlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(PlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(PlayVersion obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(PlayVersion obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(PlayVersion) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(PlayVersion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(PlayVersion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(PlayVersion obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(PlayVersion) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(PlayVersion obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( PlayVersion obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(FK_TELEPLAY_ID, obj.getFkTeleplayId());
              criteria.add(CATE, obj.getCate());
              criteria.add(SUBCATE, obj.getSubcate());
              criteria.add(NAME, obj.getName());
              criteria.add(VIEW_NAME, obj.getViewName());
              criteria.add(ALIAS, obj.getAlias());
              criteria.add(ORDER_ID, obj.getOrderId());
              criteria.add(REVERSE, obj.getReverse());
              criteria.add(EPISODE_COUNT, obj.getEpisodeCount());
              criteria.add(TOTAL_COUNT, obj.getTotalCount());
              criteria.add(FIXED, obj.getFixed());
              criteria.add(FIRSTLOGO, obj.getFirstlogo());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( PlayVersion obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static PlayVersion retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayVersion retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayVersion retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        PlayVersion retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static PlayVersion retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<PlayVersion> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<PlayVersion> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PlayVersion> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<PlayVersion> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<PlayVersion>();
        }
        else
        {
            Criteria criteria = new Criteria();
