    ...
    extends BasePeer
{
    ...
    {
        return getMapBuilder(EpisodeLogMapBuilder.CLASS_NAME);
    }
    ...
    public static final String KEYWORD;
      /** the column name for the fk_episode_id field */
    public static final String FK_EPISODE_ID;
    ...
    static
    {
        ...
        TABLE_NAME = "episode_log";
              ...
              ID = "episode_log.id";
                  KEYWORD = "episode_log.keyword";
                  FK_EPISODE_ID = "episode_log.fk_episode_id";
                  CREATETIME = "episode_log.createtime";
                  STATUS = "episode_log.status";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(EpisodeLogMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.EpisodeLog";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(FK_EPISODE_ID);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setFkEpisodeId(row.getValue(offset + 2).asInt());
                  obj.setCreatetime(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<EpisodeLog> results = new ArrayList<EpisodeLog>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> doSelect(EpisodeLog obj) throws TorqueException
    {
    ...
    public static Criteria buildCriteria( EpisodeLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(FK_EPISODE_ID, obj.getFkEpisodeId());
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<EpisodeLog> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<EpisodeLog> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeLog> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<EpisodeLog> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<EpisodeLog>();
        }
        else
        {
            Criteria criteria = new Criteria();
