 ...
 *
 */
public abstract class BaseFeedbackPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(FeedbackMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the fk_version_id field */
    public static final String FK_VERSION_ID;
      /** the column name for the episode_id field */
    public static final String EPISODE_ID;
    ...
    public static final String ERROR_TYPE;
      /** the column name for the error_content field */
    public static final String ERROR_CONTENT;
      /** the column name for the feednum field */
    public static final String FEEDNUM;
      /** the column name for the lastModefyDate field */
    public static final String LASTMODEFYDATE;
      /** the column name for the status field */
    public static final String STATUS;
      /** the column name for the operator field */
    public static final String OPERATOR;
      /** the column name for the operateDate field */
    ...
    static
    {
        ...
        TABLE_NAME = "feedback";
              ...
              ID = "feedback.id";
                  FK_VERSION_ID = "feedback.fk_version_id";
                  EPISODE_ID = "feedback.episode_id";
                  VIDEO_ID = "feedback.video_id";
                  KEYWORD = "feedback.keyword";
                  ERROR_TYPE = "feedback.error_type";
                  ERROR_CONTENT = "feedback.error_content";
                  FEEDNUM = "feedback.feednum";
                  LASTMODEFYDATE = "feedback.lastModefyDate";
                  STATUS = "feedback.status";
                  OPERATOR = "feedback.operator";
                  OPERATEDATE = "feedback.operateDate";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(FeedbackMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(FeedbackMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Feedback";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(FK_VERSION_ID);
          criteria.addSelectColumn(EPISODE_ID);
          criteria.addSelectColumn(VIDEO_ID);
          criteria.addSelectColumn(KEYWORD);
          criteria.addSelectColumn(ERROR_TYPE);
          criteria.addSelectColumn(ERROR_CONTENT);
          criteria.addSelectColumn(FEEDNUM);
          criteria.addSelectColumn(LASTMODEFYDATE);
          criteria.addSelectColumn(STATUS);
          criteria.addSelectColumn(OPERATOR);
          criteria.addSelectColumn(OPERATEDATE);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Feedback row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Feedback obj = (Feedback) cls.newInstance();
            FeedbackPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setFkVersionId(row.getValue(offset + 1).asInt());
                  obj.setEpisodeId(row.getValue(offset + 2).asInt());
                  obj.setVideoId(row.getValue(offset + 3).asInt());
                  obj.setKeyword(row.getValue(offset + 4).asString());
                  obj.setErrorType(row.getValue(offset + 5).asInt());
                  obj.setErrorContent(row.getValue(offset + 6).asString());
                  obj.setFeednum(row.getValue(offset + 7).asInt());
                  obj.setLastmodefydate(row.getValue(offset + 8).asUtilDate());
                  obj.setStatus(row.getValue(offset + 9).asInt());
                  obj.setOperator(row.getValue(offset + 10).asString());
                  obj.setOperatedate(row.getValue(offset + 11).asUtilDate());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Feedback> results = new ArrayList<Feedback>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(FeedbackPeer.row2Object(row, 1,
                FeedbackPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> doSelect(Feedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Feedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Feedback obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Feedback obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Feedback) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Feedback obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Feedback) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Feedback obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Feedback) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Feedback obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Feedback obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(FK_VERSION_ID, obj.getFkVersionId());
              criteria.add(EPISODE_ID, obj.getEpisodeId());
              criteria.add(VIDEO_ID, obj.getVideoId());
              criteria.add(KEYWORD, obj.getKeyword());
              criteria.add(ERROR_TYPE, obj.getErrorType());
              criteria.add(ERROR_CONTENT, obj.getErrorContent());
              criteria.add(FEEDNUM, obj.getFeednum());
              criteria.add(LASTMODEFYDATE, obj.getLastmodefydate());
              criteria.add(STATUS, obj.getStatus());
              criteria.add(OPERATOR, obj.getOperator());
              criteria.add(OPERATEDATE, obj.getOperatedate());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Feedback obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Feedback retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Feedback retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Feedback retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Feedback retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Feedback retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Feedback> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Feedback> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Feedback> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Feedback>();
        }
        else
        {
            Criteria criteria = new Criteria();
