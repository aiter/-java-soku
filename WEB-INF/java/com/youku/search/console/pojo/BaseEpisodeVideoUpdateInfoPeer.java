 ...
 *
 */
public abstract class BaseEpisodeVideoUpdateInfoPeer
    extends BasePeer
{
    /** Serial version */
    private static final long serialVersionUID = 1290066367140L;
    ...
    {
        return getMapBuilder(EpisodeVideoUpdateInfoMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the stamp_date field */
    public static final String STAMP_DATE;
      /** the column name for the day_date field */
    public static final String DAY_DATE;
      /** the column name for the operate_name field */
    public static final String OPERATE_NAME;
    ...
    static
    {
        ...
        TABLE_NAME = "episode_video_update_info";

              ID = "episode_video_update_info.id";
                  STAMP_DATE = "episode_video_update_info.stamp_date";
                  DAY_DATE = "episode_video_update_info.day_date";
                  OPERATE_NAME = "episode_video_update_info.operate_name";
                  STATE = "episode_video_update_info.state";
                  NUM = "episode_video_update_info.num";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(EpisodeVideoUpdateInfoMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(EpisodeVideoUpdateInfoMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.EpisodeVideoUpdateInfo";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseEpisodeVideoUpdateInfoPeer
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(STAMP_DATE);
          criteria.addSelectColumn(DAY_DATE);
          criteria.addSelectColumn(OPERATE_NAME);
          criteria.addSelectColumn(STATE);
          criteria.addSelectColumn(NUM);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static EpisodeVideoUpdateInfo row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            EpisodeVideoUpdateInfo obj = (EpisodeVideoUpdateInfo) cls.newInstance();
            EpisodeVideoUpdateInfoPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      EpisodeVideoUpdateInfo obj)
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setStampDate(row.getValue(offset + 1).asString());
                  obj.setDayDate(row.getValue(offset + 2).asString());
                  obj.setOperateName(row.getValue(offset + 3).asString());
                  obj.setState(row.getValue(offset + 4).asString());
                  obj.setNum(row.getValue(offset + 5).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<EpisodeVideoUpdateInfo> results = new ArrayList<EpisodeVideoUpdateInfo>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(EpisodeVideoUpdateInfoPeer.row2Object(row, 1,
                EpisodeVideoUpdateInfoPeer.getOMClass()));
          }
        return results;
    }
    ...
    {
         BaseEpisodeVideoUpdateInfoPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> doSelect(EpisodeVideoUpdateInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EpisodeVideoUpdateInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EpisodeVideoUpdateInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EpisodeVideoUpdateInfo obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(EpisodeVideoUpdateInfo) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EpisodeVideoUpdateInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(EpisodeVideoUpdateInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EpisodeVideoUpdateInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(EpisodeVideoUpdateInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EpisodeVideoUpdateInfo obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( EpisodeVideoUpdateInfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(STAMP_DATE, obj.getStampDate());
              criteria.add(DAY_DATE, obj.getDayDate());
              criteria.add(OPERATE_NAME, obj.getOperateName());
              criteria.add(STATE, obj.getState());
              criteria.add(NUM, obj.getNum());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( EpisodeVideoUpdateInfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static EpisodeVideoUpdateInfo retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EpisodeVideoUpdateInfo retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EpisodeVideoUpdateInfo retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        EpisodeVideoUpdateInfo retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EpisodeVideoUpdateInfo retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<EpisodeVideoUpdateInfo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (EpisodeVideoUpdateInfo)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<EpisodeVideoUpdateInfo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EpisodeVideoUpdateInfo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<EpisodeVideoUpdateInfo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<EpisodeVideoUpdateInfo>();
        }
        else
        {
            Criteria criteria = new Criteria();
