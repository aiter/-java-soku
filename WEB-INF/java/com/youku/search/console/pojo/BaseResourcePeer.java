 ...
 *
 */
public abstract class BaseResourcePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(ResourceMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(ResourceMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(ResourceMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Resource";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Resource row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Resource obj = (Resource) cls.newInstance();
            ResourcePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Resource> results = new ArrayList<Resource>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(ResourcePeer.row2Object(row, 1,
                ResourcePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> doSelect(Resource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Resource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Resource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Resource obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Resource) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Resource obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Resource) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Resource obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Resource) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Resource obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Resource obj )
    {
    ...
    public static Criteria buildSelectCriteria( Resource obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Resource retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Resource retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Resource retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Resource retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Resource> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Resource> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Resource> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Resource>();
        }
        else
        {
            Criteria criteria = new Criteria();
