 ...
 *
 */
public abstract class BaseSearchLogPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(SearchLogMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the words field */
    public static final String WORDS;
      /** the column name for the url field */
    public static final String URL;
      /** the column name for the stop field */
    public static final String STOP;
      /** the column name for the search_time field */
    public static final String SEARCH_TIME;
    ...
    static
    {
        ...
        TABLE_NAME = "search_log";
              ...
              ID = "search_log.id";
                  WORDS = "search_log.words";
                  URL = "search_log.url";
                  STOP = "search_log.stop";
                  SEARCH_TIME = "search_log.search_time";
                  UPDATE_TIME = "search_log.update_time";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(SearchLogMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(SearchLogMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.SearchLog";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(WORDS);
          criteria.addSelectColumn(URL);
          criteria.addSelectColumn(STOP);
          criteria.addSelectColumn(SEARCH_TIME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SearchLog row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SearchLog obj = (SearchLog) cls.newInstance();
            SearchLogPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setWords(row.getValue(offset + 1).asString());
                  obj.setUrl(row.getValue(offset + 2).asString());
                  obj.setStop(row.getValue(offset + 3).asInt());
                  obj.setSearchTime(row.getValue(offset + 4).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SearchLog> results = new ArrayList<SearchLog>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(SearchLogPeer.row2Object(row, 1,
                SearchLogPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> doSelect(SearchLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SearchLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SearchLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SearchLog obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SearchLog) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SearchLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SearchLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SearchLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SearchLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SearchLog obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SearchLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(WORDS, obj.getWords());
              criteria.add(URL, obj.getUrl());
              criteria.add(STOP, obj.getStop());
              criteria.add(SEARCH_TIME, obj.getSearchTime());
              criteria.add(UPDATE_TIME, obj.getUpdateTime());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( SearchLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static SearchLog retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchLog retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchLog retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SearchLog retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SearchLog retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SearchLog> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SearchLog> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SearchLog> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SearchLog> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SearchLog>();
        }
        else
        {
            Criteria criteria = new Criteria();
