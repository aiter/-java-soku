 ...
 *
 */
public abstract class BaseMenuResourcePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(MenuResourceMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "menu_resource";
              ...
              ID = "menu_resource.id";
                  ...
                  RESOURCE_ID = "menu_resource.resource_id";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(MenuResourceMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(MenuResourceMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.MenuResource";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(RESOURCE_ID);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static MenuResource row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            MenuResource obj = (MenuResource) cls.newInstance();
            MenuResourcePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setMenuId(row.getValue(offset + 1).asInt());
                  obj.setResourceId(row.getValue(offset + 2).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<MenuResource> results = new ArrayList<MenuResource>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(MenuResourcePeer.row2Object(row, 1,
                MenuResourcePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> doSelect(MenuResource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(MenuResource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(MenuResource obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(MenuResource obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(MenuResource) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(MenuResource obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(MenuResource) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(MenuResource obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(MenuResource) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(MenuResource obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( MenuResource obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(MENU_ID, obj.getMenuId());
              criteria.add(RESOURCE_ID, obj.getResourceId());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( MenuResource obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static MenuResource retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static MenuResource retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static MenuResource retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        MenuResource retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static MenuResource retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<MenuResource> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<MenuResource> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<MenuResource> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<MenuResource> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<MenuResource>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of MenuResource objects pre-filled with their
     * Menu objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MenuResourcePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<MenuResource> doSelectJoinMenu(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinMenu(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<MenuResource> doSelectJoinMenu(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        MenuResourcePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        MenuPeer.addSelectColumns(criteria);

                        criteria.addJoin(MenuResourcePeer.MENU_ID,
            MenuPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);
                            ...
                            Class omClass = MenuResourcePeer.getOMClass();
                    MenuResource obj1 = MenuResourcePeer
            ...
            {
                MenuResource temp_obj1 =  results.get(j);
                Menu temp_obj2 = temp_obj1.getMenu();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addMenuResource(obj1);
                              break;
                }
            }
                      if (newObject)
            {
                obj2.initMenuResources();
                obj2.addMenuResource(obj1);
            }
                      results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<MenuResource> doSelectJoinResource(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinResource(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<MenuResource> doSelectJoinResource(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        ResourcePeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(MenuResourcePeer.RESOURCE_ID,
            ResourcePeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);
                    ...
                    MenuResource obj1 = MenuResourcePeer
                .row2Object(row, 1, omClass);
                     omClass = ResourcePeer.getOMClass();
                    Resource obj2 = ResourcePeer
                .row2Object(row, offset, omClass);
            ...
            {
                MenuResource temp_obj1 =  results.get(j);
                Resource temp_obj2 = temp_obj1.getResource();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addMenuResource(obj1);
