 ...
 *
 */
public abstract class BaseRavietyExcludePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(RavietyExcludeMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "raviety_exclude";

              ID = "raviety_exclude.id";
                  FK_TELEPLAY_ID = "raviety_exclude.fk_teleplay_id";
                  NAME = "raviety_exclude.name";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(RavietyExcludeMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(RavietyExcludeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.RavietyExclude";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static RavietyExclude row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            RavietyExclude obj = (RavietyExclude) cls.newInstance();
            RavietyExcludePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<RavietyExclude> results = new ArrayList<RavietyExclude>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(RavietyExcludePeer.row2Object(row, 1,
                RavietyExcludePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> doSelect(RavietyExclude obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RavietyExclude obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RavietyExclude obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RavietyExclude obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RavietyExclude) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RavietyExclude obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(RavietyExclude) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RavietyExclude obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(RavietyExclude) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RavietyExclude obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( RavietyExclude obj )
    {
    ...
    public static Criteria buildSelectCriteria( RavietyExclude obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static RavietyExclude retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RavietyExclude retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RavietyExclude retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        RavietyExclude retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RavietyExclude retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<RavietyExclude> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<RavietyExclude> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RavietyExclude> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<RavietyExclude> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<RavietyExclude>();
        }
        else
        {
            Criteria criteria = new Criteria();
