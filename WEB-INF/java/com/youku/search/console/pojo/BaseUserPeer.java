    ...
    extends BasePeer
{
    ...
    public static final String PASSWORD;
      /** the column name for the true_name field */
    ...
    public static final String BIRTH;
      /** the column name for the lastLoginDate field */
    public static final String LASTLOGINDATE;
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.User";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(TRUE_NAME);
          criteria.addSelectColumn(TEAM);
          criteria.addSelectColumn(SEX);
          criteria.addSelectColumn(BIRTH);
          criteria.addSelectColumn(LASTLOGINDATE);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<User> results = new ArrayList<User>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> doSelect(User obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<User> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<User> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<User>();
        }
        else
        {
            Criteria criteria = new Criteria();
