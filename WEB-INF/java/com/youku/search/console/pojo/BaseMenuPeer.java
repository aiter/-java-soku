 ...
 *
 */
public abstract class BaseMenuPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(MenuMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the father_id field */
    public static final String FATHER_ID;
      /** the column name for the module field */
    public static final String MODULE;
      /** the column name for the name field */
    public static final String NAME;
      /** the column name for the menuUrl field */
    ...
    static
    {
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(MenuMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(MenuMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Menu";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(FATHER_ID);
          criteria.addSelectColumn(MODULE);
          criteria.addSelectColumn(NAME);
          criteria.addSelectColumn(MENUURL);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Menu row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Menu obj = (Menu) cls.newInstance();
            MenuPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setFatherId(row.getValue(offset + 1).asInt());
                  obj.setModule(row.getValue(offset + 2).asString());
                  obj.setName(row.getValue(offset + 3).asString());
                  obj.setMenuurl(row.getValue(offset + 4).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Menu> results = new ArrayList<Menu>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(MenuPeer.row2Object(row, 1,
                MenuPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> doSelect(Menu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Menu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Menu obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Menu obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Menu) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Menu obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Menu) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Menu obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Menu) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Menu obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Menu obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(FATHER_ID, obj.getFatherId());
              criteria.add(MODULE, obj.getModule());
              criteria.add(NAME, obj.getName());
              criteria.add(MENUURL, obj.getMenuurl());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Menu obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Menu retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Menu retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Menu retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Menu retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Menu retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Menu> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Menu> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Menu> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Menu>();
        }
        else
        {
            Criteria criteria = new Criteria();
