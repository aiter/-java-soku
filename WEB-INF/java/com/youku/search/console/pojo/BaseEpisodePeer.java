 ...
 *
 */
public abstract class BaseEpisodePeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(EpisodeMapBuilder.CLASS_NAME);
    }
    ...
    public static final String SECONDS;
      /** the column name for the isLock field */
    public static final String ISLOCK;
    ...
    static
    {
        ...
        TABLE_NAME = "episode";
              ...
              ID = "episode.id";
                  FK_TELEPLAY_ID = "episode.fk_teleplay_id";
                  FK_VERSION_ID = "episode.fk_version_id";
                  NAME = "episode.name";
                  ORDER_ID = "episode.order_id";
                  SOURCE_NAME = "episode.source_name";
                  VIDEO_ID = "episode.video_id";
                  ENCODE_VIDEO_ID = "episode.encode_video_id";
                  LOGO = "episode.logo";
              ...
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(EpisodeMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(EpisodeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Episode";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(ISLOCK);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Episode row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Episode obj = (Episode) cls.newInstance();
            EpisodePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setFkVersionId(row.getValue(offset + 2).asInt());
                  obj.setName(row.getValue(offset + 3).asString());
                  obj.setOrderId(row.getValue(offset + 4).asInt());
                  obj.setSourceName(row.getValue(offset + 5).asString());
                  obj.setVideoId(row.getValue(offset + 6).asString());
                  obj.setEncodeVideoId(row.getValue(offset + 7).asString());
                  obj.setLogo(row.getValue(offset + 8).asString());
                  obj.setSeconds(row.getValue(offset + 9).asDouble());
                  obj.setIslock(row.getValue(offset + 10).asInt());
                  obj.setFileId(row.getValue(offset + 11).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Episode> results = new ArrayList<Episode>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(EpisodePeer.row2Object(row, 1,
                EpisodePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> doSelect(Episode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Episode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Episode obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Episode obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Episode) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Episode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Episode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Episode obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Episode) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Episode obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Episode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(ID, obj.getId());
              ...
              criteria.add(ISLOCK, obj.getIslock());
              criteria.add(FILE_ID, obj.getFileId());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Episode obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Episode retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Episode retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Episode retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Episode retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Episode retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Episode> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Episode> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Episode> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Episode> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Episode>();
        }
        else
        {
            Criteria criteria = new Criteria();
