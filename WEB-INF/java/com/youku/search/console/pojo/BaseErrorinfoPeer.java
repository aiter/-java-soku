 ...
 *
 */
public abstract class BaseErrorinfoPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(ErrorinfoMapBuilder.CLASS_NAME);
    }
    ...
    public static final String URL;
      /** the column name for the lasttime field */
    public static final String LASTTIME;
    ...
    static
    {
        ...
        TABLE_NAME = "errorinfo";

              ID = "errorinfo.id";
                  URL = "errorinfo.url";
                  LASTTIME = "errorinfo.lasttime";
                  NUM = "errorinfo.num";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(ErrorinfoMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(ErrorinfoMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Errorinfo";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(LASTTIME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Errorinfo row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Errorinfo obj = (Errorinfo) cls.newInstance();
            ErrorinfoPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setLasttime(row.getValue(offset + 2).asString());
                  obj.setNum(row.getValue(offset + 3).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Errorinfo> results = new ArrayList<Errorinfo>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(ErrorinfoPeer.row2Object(row, 1,
                ErrorinfoPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> doSelect(Errorinfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Errorinfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Errorinfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Errorinfo obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Errorinfo) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Errorinfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Errorinfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Errorinfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Errorinfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Errorinfo obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Errorinfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(URL, obj.getUrl());
              criteria.add(LASTTIME, obj.getLasttime());
              criteria.add(NUM, obj.getNum());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Errorinfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Errorinfo retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Errorinfo retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Errorinfo retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Errorinfo retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Errorinfo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Errorinfo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Errorinfo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Errorinfo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Errorinfo>();
        }
        else
        {
            Criteria criteria = new Criteria();
