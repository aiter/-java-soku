 ...
 *
 */
public abstract class BaseTeleplayPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TeleplayMapBuilder.CLASS_NAME);
    }

      /** the column name for the id field */
    public static final String ID;
      /** the column name for the version_count field */
    public static final String VERSION_COUNT;
    ...
    static
    {
        ...
        TABLE_NAME = "teleplay";
              ...
              ID = "teleplay.id";
                  VERSION_COUNT = "teleplay.version_count";
                  IS_VALID = "teleplay.is_valid";
                  CATE = "teleplay.cate";
                  SUBCATE = "teleplay.subcate";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TeleplayMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TeleplayMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Teleplay";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(VERSION_COUNT);
          criteria.addSelectColumn(IS_VALID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Teleplay row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Teleplay obj = (Teleplay) cls.newInstance();
            TeleplayPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setVersionCount(row.getValue(offset + 1).asInt());
                  obj.setIsValid(row.getValue(offset + 2).asInt());
                  obj.setCate(row.getValue(offset + 3).asInt());
                  obj.setSubcate(row.getValue(offset + 4).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Teleplay> results = new ArrayList<Teleplay>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TeleplayPeer.row2Object(row, 1,
                TeleplayPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> doSelect(Teleplay obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Teleplay obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Teleplay obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Teleplay obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Teleplay) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Teleplay obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Teleplay) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Teleplay obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Teleplay) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Teleplay obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Teleplay obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(VERSION_COUNT, obj.getVersionCount());
              criteria.add(IS_VALID, obj.getIsValid());
    ...
    public static Criteria buildSelectCriteria( Teleplay obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Teleplay retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Teleplay retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Teleplay retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Teleplay retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Teleplay retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Teleplay> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Teleplay> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Teleplay> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Teleplay> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Teleplay>();
        }
        else
        {
            Criteria criteria = new Criteria();
