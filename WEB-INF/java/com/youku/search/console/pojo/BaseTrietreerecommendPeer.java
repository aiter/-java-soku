 ...
 *
 */
public abstract class BaseTrietreerecommendPeer
    extends BasePeer
{
    /** Serial version */
    ...
    {
        return getMapBuilder(TrietreerecommendMapBuilder.CLASS_NAME);
    }
    ...
    public static final String KEYWORD;
      /** the column name for the keyword_py field */
    public static final String KEYWORD_PY;
      /** the column name for the recomend_type field */
    public static final String RECOMEND_TYPE;
      /** the column name for the query_count field */
    ...
    static
    {
        DATABASE_NAME = "searchrecommend";
        TABLE_NAME = "trieTreeRecommend";

              ID = "trieTreeRecommend.id";
                  KEYWORD = "trieTreeRecommend.keyword";
                  KEYWORD_PY = "trieTreeRecommend.keyword_py";
                  RECOMEND_TYPE = "trieTreeRecommend.recomend_type";
                  QUERY_COUNT = "trieTreeRecommend.query_count";
                  RESULT = "trieTreeRecommend.result";
                  STARTTIME = "trieTreeRecommend.starttime";
                  ENDTIME = "trieTreeRecommend.endtime";
                  CREATOR = "trieTreeRecommend.creator";
                  CREATETIME = "trieTreeRecommend.createtime";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(TrietreerecommendMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(TrietreerecommendMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Trietreerecommend";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTrietreerecommendPeer
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(KEYWORD_PY);
          criteria.addSelectColumn(RECOMEND_TYPE);
          criteria.addSelectColumn(QUERY_COUNT);
          criteria.addSelectColumn(RESULT);
          criteria.addSelectColumn(STARTTIME);
          criteria.addSelectColumn(ENDTIME);
          criteria.addSelectColumn(CREATOR);
          criteria.addSelectColumn(CREATETIME);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Trietreerecommend row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Trietreerecommend obj = (Trietreerecommend) cls.newInstance();
            TrietreerecommendPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      Trietreerecommend obj)
        throws TorqueException
    {
        try
        {
                obj.setId(row.getValue(offset + 0).asInt());
                  obj.setKeyword(row.getValue(offset + 1).asString());
                  obj.setKeywordPy(row.getValue(offset + 2).asString());
                  obj.setRecomendType(row.getValue(offset + 3).asString());
                  obj.setQueryCount(row.getValue(offset + 4).asInt());
                  obj.setResult(row.getValue(offset + 5).asInt());
                  obj.setStarttime(row.getValue(offset + 6).asUtilDate());
                  obj.setEndtime(row.getValue(offset + 7).asUtilDate());
                  obj.setCreator(row.getValue(offset + 8).asString());
                  obj.setCreatetime(row.getValue(offset + 9).asUtilDate());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Trietreerecommend> results = new ArrayList<Trietreerecommend>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(TrietreerecommendPeer.row2Object(row, 1,
                TrietreerecommendPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> doSelect(Trietreerecommend obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Trietreerecommend obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Trietreerecommend obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Trietreerecommend obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Trietreerecommend) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Trietreerecommend obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Trietreerecommend) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Trietreerecommend obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Trietreerecommend) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Trietreerecommend obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Trietreerecommend obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(ID, obj.getId());
              criteria.add(KEYWORD, obj.getKeyword());
              criteria.add(KEYWORD_PY, obj.getKeywordPy());
              criteria.add(RECOMEND_TYPE, obj.getRecomendType());
              criteria.add(QUERY_COUNT, obj.getQueryCount());
              criteria.add(RESULT, obj.getResult());
              criteria.add(STARTTIME, obj.getStarttime());
              criteria.add(ENDTIME, obj.getEndtime());
              criteria.add(CREATOR, obj.getCreator());
              criteria.add(CREATETIME, obj.getCreatetime());
          return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Trietreerecommend obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static Trietreerecommend retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Trietreerecommend retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Trietreerecommend retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Trietreerecommend retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Trietreerecommend retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Trietreerecommend> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (Trietreerecommend)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Trietreerecommend> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Trietreerecommend> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Trietreerecommend> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Trietreerecommend>();
        }
        else
        {
            Criteria criteria = new Criteria();
