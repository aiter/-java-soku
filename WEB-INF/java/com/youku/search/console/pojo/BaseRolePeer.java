    ...
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.search.console.pojo.Role";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Role> results = new ArrayList<Role>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> doSelect(Role obj) throws TorqueException
    {
    ...
    public static Criteria buildSelectCriteria( Role obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Role retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<Role> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Role> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Role> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Role>();
        }
        else
        {
            Criteria criteria = new Criteria();
