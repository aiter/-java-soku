...
public class QuickQueryAction implements ServletRequestAware {
	...
	public void putDateToOutputStream(OutputStream os){
		...
		qvomap = QuickTopDataWebMgt.getInstance().getQuickVODataReturnMapOrderByQuerySub(downdate, limit);
		try {
