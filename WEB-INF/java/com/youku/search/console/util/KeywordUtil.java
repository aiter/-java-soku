...
public class KeywordUtil {
	...
	final static String wordRegexp = "((中字|中文字幕|英文原声|中英文|中英双语|中英双字幕|双语字幕|国英|双语|国语|粤语|日语|韩语|汉语|无字幕|字幕|DVD|中文高清|高清|清晰|TV)+版*)|抢先看|美剧|日剧|韩剧|偶像剧|全集|电影|电视";
	...
	public static void main(String[] args) {
		System.out.println(filter("滇西第一集"));
	}
