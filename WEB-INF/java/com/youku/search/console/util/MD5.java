...
public final class MD5 {
	 ...
	 * numbers as digits. 
	 * Contains two hex digit characters for each byte from the pacom.sse.portald in 
	 * <code>byte[]</code>.
	 * 
