 ...
 * 会员搜索监控
 */
public class BarMonitor extends AMonitor{
	...
	public Result check() {
		Result r = new Result();
		String url = "http://"+ Config.getYoukuHost() +"/search?type=9&keyword=%E4%BC%98%E9%85%B7&pagesize=1&source=monitor";
