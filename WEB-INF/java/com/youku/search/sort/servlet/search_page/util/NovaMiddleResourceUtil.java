...
public class NovaMiddleResourceUtil {
	...
	public static JSONArray recommendShows(String showids) {
		...
		final String fd = "showcategory showname performer releasedate show_thumburl streamtypes paid showday_vv showtotal_vv reputation ";
	...
	public static void main(String[] args) {
		System.out.println(recommendShows("1b21e5fe12c311df97c0,cc13a9cc962411de83b1"));
	}
