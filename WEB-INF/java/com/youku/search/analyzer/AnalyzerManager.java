...
//			log.setLevel( 3 );
	...
	public synchronized static void initAnalysisClient(String poolname){
	...
	public static String analysis(MemCachedClient mc, String inString){
		Object r = null;
		try{
	...
	public static String analyzeWord(String words)
	{
		...
		try
		{
			String sendStr = (new StringBuilder(" ")).append(words).append(" ").toString();
//			System.out.println("sendStr:'"+sendStr+"'");
			s = analysis(mc, sendStr);//加空格解决词语歧义问题，获取后处理
//			System.out.println("receiveStr:'"+s+"'");
...
//			System.out.println("returnStr:'"+s+"'");
	...
	public static void main(String[] args){
		initAnalysis(poolname,"E:/work/youku/search/src/WEB-INF/conf/memcache.tok");
		analyzeWord("china");
	}
}
