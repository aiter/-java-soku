...
public class StringUtil {
	 ...
	 */
	    ...
	    public static void main(String[] args){
	    	System.out.println(URLEncoder.encode("火影忍者"));
	    	System.out.println(StringUtil.toUnicode("火影忍者", false));
	    	char[] c="\\u7F8E\\u5973".toCharArray();
	    	System.out.println(StringUtil.fromUnicode(c, 0, c.length, new char[]{}));
	    }
	}
