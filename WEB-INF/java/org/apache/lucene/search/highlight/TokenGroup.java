  ...
  void addToken(Token token, float score)
	{
        ...
        {	
//	    	System.out.println(token.termText()+"\tnumTokens="+numTokens+"\toffset="+token.startOffset() +"\tend=" + token.endOffset()+"\tscore="+score);
			if(numTokens==0)
			{
...
//	    System.out.println(token.termText()+ "matchStartOffset="+matchStartOffset + "matchEndOffset="+matchEndOffset);
	}
