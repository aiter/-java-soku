...
JSONArray version_names = teleplay.optJSONArray("version_names");
int current_version_id = teleplay.getInt("current_version_id");
JSONArray episodes = teleplay.optJSONArray("current_site_episode");
JSONObject names = teleplay.optJSONObject("names");
JSONArray sites = teleplay.optJSONArray("current_sites");
int current_site_id = teleplay.getInt("current_site_id");
JSONObject version = teleplay.optJSONObject("current_version");
JSONObject siteversion = teleplay.optJSONObject("current_site_version");
...
int episode_order= teleplay.optInt("episode_order");
%>
