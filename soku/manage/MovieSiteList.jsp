...
<html>
<head>
<title><s:text name="movieSite.title.list" /></title>
	...
	<script type="text/javascript">
		...
		function setDefaultSite(movieSiteId) {
			$.ajax({					
				url: '<s:url action="MovieSite_setDefaultSite" />',
				type: 'GET',
				data: 'movieSiteId=' + movieSiteId ,
  ...
  <div id="middle">
    ...
    <div id="center-column">
      ...
      <div class="select-bar">
         <s:form action="MovieSite_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="movieSiteFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="MovieSite_batchdelete" validate="false" cssClass="form" theme="simple">
        <table class="listing" cellpadding="0" cellspacing="0">
				...
				<s:iterator value="movieSiteList" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<td align="center">
						<a id="setDefaultSite" class="listbutton" onclick="setDefaultSite(<s:property value="id" />);">设置默认站点</a>
						<a name="deleteLink" class="listbutton"
							href="<s:url action="MovieSite_delete">
								<s:param name="movieSiteId" value="id"/>
								<s:param name="movieId" value="movieId"/>
						...
						<s:text name="movie.delete" /> </a> &nbsp; <a class="listbutton"
							href="<s:url action="MovieSite_input">
								<s:param name="movieSiteId" value="id"/>
								<s:param name="movieId" value="movieId"/>
								<s:param name="statusFilter" value="statusFilter"/>
								<s:param name="searchWord" value="searchWord"/>
				 ...
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="MovieSite_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="MovieSite_list">
								<s:param name="searchWord" value="searchWord" />
								<s:param name="siteFilter" value="siteFilter" />
								<s:param name="statusFilter"><s:property value="statusFilter"/></s:param>
    ...
    <div id="right-column"> <strong class="h"><s:text name="soku.categoryfilter" /></strong>
    	...
    	<ul class="nav">
    		<li>
	    		<a href="<s:url action="MovieSite_list"><s:param name="pageNumber" value="1" /></s:url>">
        	...
        	<li>
        		<a href="<s:url action="MovieSite_list"><s:param name="siteFilter"><s:property value="key"/></s:param>
        					<s:param name="statusFilter"><s:property value="statusFilter"/></s:param>
        					<s:param name="searchWord" value="searchWord" />
        				</s:url>">
