  ...
  <div id="middle">
    ...
    <div id="center-column">
      ...
      <div class="select-bar">
         <s:form action="AuditEpisodeLog_list" validate="true" cssClass="form" theme="simple">
			...
			站点： 
			<s:select key="siteId" list="siteFilterMap" listKey="key" listValue="value"></s:select>
			
			类型：
			<s:select key="categoryFilter" list="directCategory" listKey="key" listValue="value" cssClass="text"></s:select>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <table id="sorttable" class="listing" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<th align="center" width="20%">收录集数</th>
					<th align="center" width="10%">通过</th>
					<th align="center" width="10%">不通过</th>
					<th align="center" width="20%">全剧情况</th>
				...
				<s:iterator value="pageInfo.results" status="index" >
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						<td align="center">
							<a href="/VideoInfo_input.do?videoId=<s:property value="id"/>"><s:property value="name"/></a>
						...
						<td align="left" colspan="3">
								<s:iterator value="siteEpisodeLogList" status="siteIndex">
								<s:if test="episodeLogList.size > 0">
									<div class="site_toggle">
										<h3><s:property value="siteName"/></h3>							
										<div>
										<table width="100%" cellpadding="0" cellspacing="0">
											<s:iterator value="episodeLogList" >
												<tr>
													
												
													<td width="50%">
														<s:if test="cateId == 1 || cateId == 5"><a target="_blank" title="<s:property value="title"/>" href="<s:property value="url"/>">第<s:property value="orderId"/>集</a></s:if>
														<s:if test="cateId == 2"><a target="_blank" title="<s:property value="title"/>" href="<s:property value="url"/>">播放</a></s:if>
														<s:if test="cateId == 3"><a target="_blank" title="<s:property value="title"/>" href="<s:property value="url"/>">第<s:property value="orderStage"/>期</a></s:if>
														</td>
												
												<s:if test="id > 0">
												
													<td width="25%"><a href="<s:url action="AuditEpisodeLog_auditPass">
																...
																<s:param name="logId" value="id"/>
																<s:param name="logId" value="id"/>
																<s:param name="pageNumber" value="pageNumber" />
																</s:url>">通过</a></td>
												
													<td width="25%"><a href="<s:url action="AuditEpisodeLog_auditFail">
																<s:param name="searchWord" value="searchWord"/>	
																<s:param name="accuratelyMatched" value="accuratelyMatched"/>
																<s:param name="concernLevel" value="concernLevel"/>
																<s:param name="siteId" value="siteId"></s:param>
						...
						<td align="center">
							<a href="/EpisodeDetail_detail.do?programmeId=<s:property value="id"/>">查看</a>
						</td>
				 ...
				 <tfoot>
					...
					value="pageInfo.totalRecords" /> ----
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="AuditEpisodeLog_list"> 
					...
					value="<s:url action="AuditEpisodeLog_list">
												<s:param name="searchWord" value="searchWord"/>	
												<s:param name="accuratelyMatched" value="accuratelyMatched"/>
												<s:param name="concernLevel" value="concernLevel"/>
												<s:param name="siteId" value="siteId"></s:param>
