...
<html>
<head>
<title><s:text name="shieldCategory.title.list" /></title>
		...
		$(function() {
		 ...
		 $("#batchdelete").click(function() {
			 ...
			 if(haschecked) {
				 if(!confirm("确认删除？"))
					 return false;
				$("#ShieldCategory_batchdelete").submit();
			 } else {
				 alert("没有数据要删除");
				 return false;
			 }
...
<div id="main">
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
      <a href="<s:url action="ShieldCategory_input">
			<s:param name="shieldCategoryId" value="-1" />
      ...
      <div class="select-bar">
         <s:form action="ShieldCategory_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="shieldCategoryFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="ShieldCategory_batchdelete" validate="false" cssClass="form" theme="simple">
        <table class="listing" cellpadding="0" cellspacing="0">

				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="20%">分类名称</th>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<td align="center"><a name="deleteLink" class="listbutton"
							href="<s:url action="ShieldCategory_delete"><s:param name="shieldCategoryId" value="id"/></s:url>">
						<s:text name="item.delete" /> </a> &nbsp; <a class="listbutton"
							href="<s:url action="ShieldCategory_input"><s:param name="shieldCategoryId" value="id"/></s:url>">
				 ...
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="ShieldCategory_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="ShieldCategory_list">
								<s:param name="searchWord" value="searchWord" />
								<s:param name="shieldCategoryFilter" value="shieldCategoryFilter" />
