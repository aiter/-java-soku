...
<html>
<head>
<title><s:text name="teleplaySiteVersion.title.list" /></title>
		...
		$(function() {
		 ...
		 $("#batchdelete").click(function() {
			 ...
			 if(haschecked) {
				if(!confirm("确认删除？"))
					 return false;
				$("#TeleplaySiteVersion_batchdelete").submit();
			 } else {
				 alert("没有数据要删除");
				 return false;
			 }
...
<div id="main">
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
      <s:if test="teleVersionId > 0">
      		<a href="<s:url action="TeleplaySiteVersion_input">
			<s:param name="teleVersionId" value="teleVersionId" />
			<s:param name="teleplaySiteVersionId" value="-1" />
				</s:url>"  class="button"><s:text
            name="teleplaySiteVersion.add"/></a>
      </s:if>      	
        <h1><s:text name="soku.teleplaySiteVersion.title" /></h1>
      </div>
      <br />
      <div class="select-bar">
         <s:form action="TeleplaySiteVersion_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="teleplaySiteVersionFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="TeleplaySiteVersion_batchdelete" validate="false" cssClass="form" theme="simple">
        <table class="listing" cellpadding="0" cellspacing="0">

				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="10%"><s:text name="teleplaySiteVersion.heading.names" /></th>
					<th align="center" width="10%"><s:text name="teleplaySiteVersion.heading.versionName" /></th>
					<th align="center" width="10%"><s:text name="teleplaySiteVersion.heading.siteName" /></th>
					<th align="center" width="5%"><s:text name="teleplaySiteVersion.heading.orderId" /></th>
					<th align="center" width="10%"><s:text name="teleplaySiteVersion.heading.firstLogo" /></th>
					<th align="center" width="5%"><s:text name="teleplaySiteVersion.heading.episodeCollected" /></th>
					<th align="center" width="5%"><s:text name="teleplaySiteVersion.heading.completed" /></th>
					<th align="center" width="5%"><s:text name="teleplaySiteVersion.heading.blocked" /></th>
					<th align="center" width="10%"><s:text name="teleplaySiteVersion.heading.operation" /></th>
				</tr>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<td align="center"><!-- <a name="deleteLink" class="listbutton"
							href="<s:url action="TeleplaySiteVersion_delete">
								<s:param name="teleplaySiteVersionId" value="id"/>
						...
						<s:text name="teleplaySiteVersion.delete" /> </a> -->&nbsp; <a class="listbutton"
							href="<s:url action="TeleplaySiteVersion_input">
								<s:param name="teleplaySiteVersionId" value="id"/>
								<s:param name="siteFilter" value="siteFilter"/>
								<s:param name="statusFilter" value="statusFilter"/>
								<s:param name="searchWord" value="searchWord"/>
						...
						<s:text name="teleplaySiteVersion.edit" /> </a>    &nbsp; <a class="listbutton"
							href="<s:url action="TeleplayEpisode_list"><s:param name="teleplaySiteVersionId" value="id"/></s:url>">
						<s:text name="teleplaySiteVersion.episodeSearch" /> </a></td>
					</tr>
				</s:iterator>
				 ...
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="TeleplaySiteVersion_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="TeleplaySiteVersion_list">
								<s:param name="searchWord" value="searchWord" />
								<s:param name="siteFilter" value="siteFilter" />
								<s:param name="statusFilter"><s:property value="statusFilter"/></s:param>
    ...
    <div id="right-column"> <strong class="h"><s:text name="soku.categoryfilter" /></strong>
    	...
    	<ul class="nav">
    		<li>
	    		<a href="<s:url action="TeleplaySiteVersion_list"><s:param name="pageNumber" value="1" /></s:url>">
        	...
        	<li>
        		<a href="<s:url action="TeleplaySiteVersion_list"><s:param name="siteFilter"><s:property value="key"/></s:param>
        					<s:param name="statusFilter"><s:property value="statusFilter"/></s:param>
        					<s:param name="searchWord" value="searchWord" />
        				</s:url>">
