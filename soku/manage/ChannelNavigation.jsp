    ...
    <div id="center-column">
      ...
      <div class="table"> 
        ...
        <p id="validateTips"></p>
   		...
   		<s:form action="ChannelNavigation_save" validate="false" cssClass="form" >
		   ...
		   <s:iterator value="cswList" status="index">
		   	...
		   	<td><s:textarea key="cswList[%{#index.index}].navigationText" cssClass="text" theme="simple" cols="60" rows="10"/> </td>
