...
<head>
	...
	<script type="text/javascript">
		...
		$('#programmeForwardWordsubmit').click(function() {
			...
			var programmeForwardWordname = $("#ProgrammeForwardWord_save_programmeForwardWord_name"),	
			allRequiredFields = $([]).add(programmeForwardWordname);
			
			var bValid = true;
			allRequiredFields.removeClass('ui-state-error');

			bValid = bValid && checkLength(programmeForwardWordname, '栏目名称', 1, 50);
...
<s:form action="ProgrammeForwardWord_save" validate="false" cssClass="simple" >
    ...
    <s:hidden name="pageNumber" />
   		...
   		<s:textfield key="pfwBo.programmeName"  label="节目名" cssClass="text" readonly="true"/>
		<s:textfield key="pfwBo.forwardWords" label="跳转词" cssClass="text"/>
