...
<html>
<head>
<title><s:text name="person.title.list" /></title>
...
<div id="main">
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
      <a href="<s:url action="Person_input">
			<s:param name="personId" value="-1" />
      ...
      <div class="select-bar">
         <s:form action="Person_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="personFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="Person_batchdelete" validate="false" cssClass="form" theme="simple">
        <table id="sorttable" class="listing" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="20%"><s:text name="person.heading.name" /></th>
					<th align="center" width="10%"><s:text name="person.heading.sex" /></th>
					<th align="center" width="10%"><s:text name="person.heading.bloodtype" /></th>
					<th align="center" width="15%"><s:text name="person.heading.homeplace" /></th>
					<th align="center" width="15%"><s:text name="person.heading.nationality" /></th>
					<th align="center" width="10%"><s:text name="person.heading.operation" /></th>
				</tr>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr id="<s:property value="id" />">
						...
						<td align="left"><s:property value="bloodtype" /></td>
						<td align="center"><s:property value="homeplace" /></td>
						<td align="center"><s:property value="nationality" /></td>
						<td align="center"><a name="deleteLink" class="listbutton"
							href="<s:url action="Person_delete"><s:param name="personId" value="id"/></s:url>">
						<s:text name="person.delete" /> </a> &nbsp; <a class="listbutton"
							href="<s:url action="Person_input"><s:param name="personId" value="id"/></s:url>">
						<s:text name="person.edit" /> </a></td>
					</tr>
				</s:iterator>
			</tbody>
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="Person_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="Person_list">          						
								<s:param name="searchWord" value="searchWord" />
								<s:param name="personFilter" value="personFilter" />
