  ...
  <div id="middle">
    ...
    <div id="center-column">
      ...
      <div class="select-bar">
         <s:form action="DeadLinkReport_list" validate="false" cssClass="form" theme="simple">
	        起始日期： <s:textfield id="startDate" name="startDate" />
	        结束日期：  <s:textfield id="endDate" name="endDate" />
	        
	        状态:
			<s:select key="status" list="#{0:'未处理', 1:'处理'}" listKey="key" listValue="value"></s:select>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <table id="sorttable" class="listing" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<th align="center" width="20">内容</th>
					<th align="center" width="20%">集数 期数</th>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<td align="center"><a href="/EpisodeDetail_detail.do?programmeId=<s:property value="programmeId" />"><s:property value="programmeName" /> --- <s:property value="siteName" /></a> </td>
						<td align="center"><s:property value="orderStage" /></td>
						<td align="center">
							<s:if test="status == 3">处理</s:if>
							<s:else>未处理</s:else>
						</td>
						<td>
							<a class="listbutton" href="<s:url action="DeadLinkReport_handle">
				 ...
				 <tfoot>
					...
					value="pageInfo.totalRecords" /> ----
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="DeadLinkReport_list"> 
					...
					value="<s:url action="DeadLinkReport_list">
												<s:param name="startDate" value="startDate"/>	
												<s:param name="endDate" value="endDate"/>
												<s:param name="statusFilter" value="statusFilter"></s:param>
												<s:param name="type" value="type"/>
