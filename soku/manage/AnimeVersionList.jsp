...
<html>
<head>
<title><s:text name="animeVersion.title.list" /></title>
		...
		$(function() {
		 ...
		 $("#batchdelete").click(function() {			 
			 ...
			 if(haschecked) {
				 if(!confirm("确认删除？"))
					 return false;
				$("#AnimeVersion_batchdelete").submit();
			 } else {
				 alert("没有数据要删除");
				 return false;
			 }			
  ...
  <div id="middle">
    ...
    <div id="center-column">
      ...
      <div class="select-bar">
         <s:form action="AnimeVersion_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="animeVersionFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="AnimeVersion_batchdelete" validate="false" cssClass="form" theme="simple">
         <table class="listing" cellpadding="0" cellspacing="0">

				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.names" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.name" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.alias" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.cates" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.episodeTotal" /></th>
					<th align="center" width="15%"><s:text name="animeVersion.heading.area" /></th>
					<th align="center" width="10%"><s:text name="animeVersion.heading.operation" /></th>
				</tr>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<a name="deleteLink" class="listbutton"
							href="<s:url action="AnimeVersion_delete">
								<s:param name="animeVersionId" value="id"/>
								<s:param name="searchWord" value="searchWord" />
								<s:param name="pageNumber" value="pageNumber" />							
							</s:url>">
							<s:text name="animeVersion.delete" /> </a> &nbsp; 
						<a class="listbutton"
							href="<s:url action="AnimeVersion_input">
								<s:param name="animeVersionId" value="id"/>
								<s:param name="searchWord" value="searchWord" />
								<s:param name="pageNumber" value="pageNumber" />
							</s:url>">
						<s:text name="animeVersion.edit" /> </a> &nbsp; 
					    <a class="listbutton" href="<s:url action="AnimeSiteVersion_list">
							<s:param name="animeSiteVersionId" value="-1" /><s:param name="animeVersionId" value="id" />
									</s:url>" ><s:text
            							name="animeSiteVersion.list"/></a></td>
					</tr>
				</s:iterator>
				 ...
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="AnimeVersion_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="AnimeVersion_list">
								<s:param name="searchWord" value="searchWord" />
								<s:param name="animeVersionFilter" value="animeVersionFilter" />
