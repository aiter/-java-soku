  ...
  <div id="middle">
    ...
    <div id="center-column">
      ...
      <div class="select-bar">
         <s:form action="ProgrammeForwardWord_list" validate="true" cssClass="form" theme="simple">
			...
			是否有跳转词： 
			<s:select key="forwardWordStatus" list="forwardWordStatusMap" listKey="key" listValue="value"></s:select>
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <table id="sorttable" class="listing" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<th align="center" width="60%">跳转词</th>
					<th align="center" width="15%">全剧情况</th>
				...
				<s:iterator value="pageInfo.results" status="index" >
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						<td align="center">
							<a href="/EpisodeDetail_detail.do?programmeId=<s:property value="programmeId"/>"><s:property value="programmeName"/></a>
						...
						<td align="center">
						<s:property value="forwardWords"/>
						</td>
						
						<td align="center">
							<a href="/ProgrammeForwardWord_input.do?programmeId=<s:property value="programmeId"/>&pageNumber=<s:property value="pageNumber"/>">修改跳转词</a>
						</td>
				 ...
				 <tfoot>
					...
					value="pageInfo.totalRecords" /> ----
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="ProgrammeForwardWord_list"> 
