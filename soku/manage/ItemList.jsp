...
<html>
<head>
<title><s:text name="item.title.list" /></title>
...
<div id="main">
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
      <a href="<s:url action="Item_input">
			<s:param name="itemId" value="-1" />
      ...
      <div class="select-bar">
         <s:form action="Item_list" validate="false" cssClass="form" theme="simple">
      ...
      <div class="table"> <img src="img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="Item_batchdelete" validate="false" cssClass="form" theme="simple">
        <table class="listing" cellpadding="0" cellspacing="0">

				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="20%"><s:text name="item.heading.name" /></th>
					<th align="center" width="20%"><s:text name="item.heading.url" /></th>
					<th align="center" width="10%"><s:text name="item.heading.navigation" /></th>
					<th align="center" width="10%"><s:text name="item.heading.indextype" /></th>
					<th align="center" width="15%"><s:text name="item.heading.sort" /></th>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						<td align="center"><input type="checkbox" name="batchdeleteids" value="<s:property value="itemId" />" /></td>
						<td align="left"><s:property value="name"/></td>
						<td align="left"><s:property value="url" /></td>
						<td align="center">
							<s:if test='navigation == 0'>
								否
							</s:if>
							<s:if test='navigation == 1'>
								是
							</s:if>
						</td>
						<td align="center">
						...
						<td align="center"><a name="deleteLink" class="listbutton"
							href="<s:url action="Item_delete"><s:param name="itemId" value="itemId"/></s:url>">
						<s:text name="item.delete" /> </a> &nbsp; <a class="listbutton"
							href="<s:url action="Item_input"><s:param name="itemId" value="itemId"/></s:url>">
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="Item_list">
								<s:param name="searchWord" value="searchWord" />
