  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
        ...
        <h1><a href="<s:url action="AnimeVersion_input"><s:param name="animeVersionId" value="animeVersionId" /></s:url>">
        		<s:text name="soku.animeVersion.title" />
        	</a> <span class="chevron"> » </span> <s:text name="soku.animeEpisode.title" /></h1>
      </div>
      <br />
