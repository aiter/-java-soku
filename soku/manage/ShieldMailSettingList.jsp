...
<html>
<head>
<title><s:text name="shieldMailSetting.title.list" /></title>
		...
		$(function() {
		 ...
		 $("#batchdelete").click(function() {
			 ...
			 if(haschecked) {
				 if(!confirm("确认删除？"))
					 return false;
				$("#ShieldMailSetting_batchdelete").submit();
			 } else {
				 alert("没有数据要删除");
				 return false;
			 }
...
<div id="main">
  ...
  <div id="middle">
    ...
    <div id="center-column">
      <div class="top-bar"> 
      <a href="<s:url action="ShieldMailSetting_input">
			<s:param name="shieldMailSettingId" value="-1" />
      ...
      <div class="select-bar">
         <s:form action="ShieldMailSetting_list" validate="false" cssClass="form" theme="simple">
	        <s:if test="shieldMailSettingFilter!=null">
			</s:if>
      		<label>
      ...
      <div class="table"> <img src="/soku/manage/img/bg-th-left.gif" width="8" height="7" alt="" class="left" /> <img src="/soku/manage/img/bg-th-right.gif" width="7" height="7" alt="" class="right" />
        <s:form action="ShieldMailSetting_batchdelete" validate="false" cssClass="form" theme="simple">
        <table class="listing" cellpadding="0" cellspacing="0">

				<tr>
					<th align="center" width="5%"><input id="thcheck" type="checkbox" /></th>
					<th align="center" width="10%">Emial</th>
					<th align="center" width="20%">间隔时间</th>
				...
				<s:iterator value="pageInfo.results" status="index">
					<tr <s:if test="#index.odd">class="bg"</s:if>>
						...
						<td align="left"><s:property value="periods"/></td>
						
						<td align="center"><a name="deleteLink" class="listbutton"
							href="<s:url action="ShieldMailSetting_delete"><s:param name="shieldMailSettingId" value="id"/></s:url>">
						<s:text name="item.delete" /> </a> &nbsp; <a class="listbutton"
							href="<s:url action="ShieldMailSetting_input"><s:param name="shieldMailSettingId" value="id"/></s:url>">
				 ...
				 <tfoot>
					<tr>
						...
						<s:if test="pageInfo.hasPrevPage">
							<a href="<s:url action="ShieldMailSetting_list"> 
        ...
        <div class="select"> <strong>Other Pages: </strong>
           <input type="hidden" id="pageurl" value="<s:url action="ShieldMailSetting_list">
								<s:param name="searchWord" value="searchWord" />
								<s:param name="shieldMailSettingFilter" value="shieldMailSettingFilter" />
