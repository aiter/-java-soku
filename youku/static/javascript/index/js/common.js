...
function update_login_status(){
	...
	var welcome = '<span class="item">[<a onclick="login(callback)">登录</a>]</span> <span class="item">[<a href="http://www.youku.com/user_signup/" charset="0-620-0-2" target="_blank">注册</a>]</span>';
	if(username != "" && username != null){
		var uname = decodeURIComponent(username).substr(0, 15);
		if(isMiniHeader && uname.length > 3) uname = uname.substr(0, 3)+'...';
	    welcome = '<span class="item">hi, <span class="uname"><a title="'+decodeURIComponent(username).substr(0, 15)+'" href="http://'+udomain+'/'+username+'">'+uname+'</a></span></span> | <span class="item"><a charset="0-620-1" href="http://'+udomain+'/my/" target="_blank">优盘</a></span> <span class="item">[<a onclick="logout()">登出</a>]</span> ';
	}
